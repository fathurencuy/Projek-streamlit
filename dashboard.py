...
# Menampilkan Visualisasi Sepeda Berdasarkan Jam dan Status Hari Kerja
st.subheader('Penggunaan Sepeda Berdasarkan Jam dan Status Hari Kerja')
plt.figure(figsize=(12,6))
sns.lineplot(x='hr', y='cnt', hue='workingday', data=df_hour)
plt.title('Penggunaan Sepeda Berdasarkan Jam dan Status Hari Kerja')
plt.xlabel('Jam')
plt.ylabel('Jumlah Peminjaman Sepeda (cnt)')
st.pyplot(plt)
plt.close()
